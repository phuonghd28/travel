        ...
        <div class="container py-5">
            <div class="row justify-content-center py-5">
                <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">Hãy trải nghiệm ngay du lịch tại Hải Phòng</h1>
                    <p class="fs-4 text-white mb-4 animated slideInDown">Lựa chọn mục đích của bạn</p>
